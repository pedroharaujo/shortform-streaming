...
components, the Firebase bearer scheme, unauthenticated catalog and playback
authorize operations, authenticated `GET /v1/me` without `firebase_uid`, and
ErrorEnvelope status mapping.
