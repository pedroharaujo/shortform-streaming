...
SPECTACULAR_SETTINGS: dict[str, object] = {
    ...
    "DESCRIPTION": (
        ...
        "includes a playback URL. The MVP catalog is fixed to France, Android, and English; "
        "client-supplied market headers cannot alter eligibility. GET /v1/me requires "
        "FirebaseIdToken; "
