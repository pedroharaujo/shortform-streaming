...
SPECTACULAR_SETTINGS: dict[str, object] = {
    ...
    "DESCRIPTION": (
        ...
        "callback and exact provider-authenticated POST /v1/purchases/revenuecat are excluded. "
        "Health probes and anonymous catalog reads do not require user "
        ...
        "ineligible ids are 404; locked catalog-eligible episodes "
        ...
        "includes a playback URL. The server resolves the active catalog launch context "
        "(initially France, Android, Google Play, and English); client-supplied market "
        "headers, queries, or profile locale cannot widen eligibility. GET /v1/me requires "
        "FirebaseIdToken; "
