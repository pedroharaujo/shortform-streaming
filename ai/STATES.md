...
| --- | --- | --- | --- |
| `ai-ready` | Approved and safe for an agent to start. | Acceptance criteria, dependencies, decisions, and validation plan are complete. | Orchestrator assigns an isolated branch/worktree. |
