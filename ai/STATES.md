...
| `ai-in-progress` | Serial plan then implement; implementer owns the bounded change. | `ai-ready` gate passed; orchestrator has produced the Validation Manifest. | Implementation and self-check evidence are complete. |
