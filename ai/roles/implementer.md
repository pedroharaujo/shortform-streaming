...
- Work only on the assigned task and branch/worktree; do not broaden scope silently.
...
2. Inspect existing patterns and the current worktree, including unrelated user changes.
