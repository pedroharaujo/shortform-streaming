...
class DeployTrustTests(unittest.TestCase):
    ...
    def test_cloud_run_module_port_probes_and_ci_owned_image(self) -> None:
        ...
        self.assertIn("FIREBASE_APP_CHECK_MODE", text)
        self.assertIn("FIREBASE_APP_CHECK_APP_ID", text)
        self.assertIn('default     = "disabled"', _read(CLOUD_RUN_VARS))
        self.assertIn("firebaseappcheck.googleapis.com", _read(STAGING_MAIN))
