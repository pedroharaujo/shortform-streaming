...
| D-026 | Device validation sequence | Implement both platforms; required on-device/manual observation is Android until Android ship-ready; iOS device observation is required before iOS public storefront / TestFlight-quality pass, not for each implementation PR | Approved 2026-08-26 | Founder | P2-T05 close-out; later P2-T08/store/IAP/push iOS pass |
