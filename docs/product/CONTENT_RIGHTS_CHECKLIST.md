...
Implementation evidence: P2-T03-F3 evolves P2-T03-F2 into server-controlled launch configuration with generalized distribution, metadata, segment, and per-license permissions. Publication, catalog, playback, and ingestion enforce explicit free/ad/coin/paid-promotion admission; new unknown grants remain unapproved. [The launch-context runbook](../runbooks/catalog-launch-context.md) describes scope and private reapproval. P3-T01-F1 adds [editorial offer policy and serialized reward rechecks](../runbooks/access-policy.md); it cannot grant absent rights or activate the unimplemented coin wallet. Rights records in this public repository contain only synthetic fixtures or opaque references to private systems—never contracts, rates, production masters, confidential records, provider payloads, or personal data. Missing, expired, mismatched, DRM-required, or taken-down grants fail closed; the private package and media review remain human gates before licensed-master ingestion.
