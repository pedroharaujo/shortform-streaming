...
| D-001 / D-004 / D-023 / D-027 / D-031 | **Founder scope implemented 2026-09-02.** MVP is France-only on Android with an English catalog of independently approved self-owned or licensed series. P2-T03-F2 restored fixed-market licensed-right enforcement; clients do not select territory/platform/language. |
